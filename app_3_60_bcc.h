...
/* FGB */
#ifndef _app_3_60_bcc_h_
#define _app_3_60_bcc_h_
/* end FGB */
...
Rect	app_get_window_area(Window *w);
...
Rect	app_get_image_area(Image *img);

Image *	app_copy_image(Image *img);
void	app_set_image_cmap(Image *img, int cmap_size, Colour *cmap);

int 	app_image_has_transparent_pixels(Image *img);

Image *	app_image_convert_32_to_8(Image *img);
Image *	app_image_convert_8_to_32(Image *img);
void	app_image_sort_palette(Image *img);
Image *	app_scale_image(Image *src, Rect dr, Rect sr);
...
int 	app_image_find_colour(Image *img, Colour col);
